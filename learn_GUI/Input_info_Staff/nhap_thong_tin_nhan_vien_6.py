...
def Xu_ly_xac_nhan():
    ...
    ghi_chu = txt_ghi_chu.get(1.0, END)
    chuoi += "\n"+"Ghi chú: "+ghi_chu
...
d += 1
txt_ghi_chu = scrolledtext.ScrolledText(window, width=30, height=5, wrap=WORD)
Label(window, text="Ghi chú").grid(row=d, column=0, sticky=W+N)
txt_ghi_chu.grid(row=d, column=1, sticky=W)
